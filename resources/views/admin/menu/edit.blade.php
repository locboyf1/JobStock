...
@section('content')
    <section class="section">
        <div class="section-body">
            <form class="card" action="{{ route('admin.menu.update', ['id' => $menu->id]) }}" method="post" novalidate>
                @csrf
                @METHOD('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                        <label>Url</label>
                        <input class="form-control @error('url')is-invalid @enderror" name="url" value="{{ $menu->url }}"/>
                        @error('url')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="defaultCheck1" name="is_show" {{ $menu->is_show ? 'checked' : ''}}>
