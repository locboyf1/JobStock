    ...
    <section class="section">
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.blog.create') }}" class="btn btn-success mb-3"><i
                            class="
fas fa-file-medical"></i> Thêm bài viết</a>
                        ...
                        <tbody>
                            @forelse ($blogs as $blog)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title}}" width="100" height="70"/></td>
