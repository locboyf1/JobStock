...
@section('content')
    <section class="section">
        <div class="section-body">
            <form class="card" action="{{ route('admin.blog.update', ['id' => $blog->id]) }}" method="POST" novalidate
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="blog_category_id">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('content')is-invalid @enderror" name="content">{{ $blog->content }}</textarea>
                        @error('content')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        <label>Ảnh (Bỏ qua nếu không muốn đổi ảnh)</label>
